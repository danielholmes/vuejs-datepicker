(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue-the-mask'), require('date-and-time')) :
  typeof define === 'function' && define.amd ? define(['vue-the-mask', 'date-and-time'], factory) :
  (global = global || self, global.vuejsDatepicker = factory(global.vueTheMask, global.dateAndTime));
}(this, function (vueTheMask, dateAndTime) { 'use strict';

  dateAndTime = dateAndTime && dateAndTime.hasOwnProperty('default') ? dateAndTime['default'] : dateAndTime;
  ...
  function parseDate(input, format) {
    ...
    var transformedFormat = format.toUpperCase();
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm._t("clearButton", null, { slot: "clearButton" })
          ],
          2
        ),
        _vm._v(" "),
